...
function AgriDetailspage({navigation}) {
...
const ListItem = ({ weight }) => (
  <View style={styles.item}>
    <Text style={{alignSelf:"center",fontSize:17,fontWeight:"bold", textAlign:"center",padding:5}}>{weight}</Text>
  </View>
);
const [modal, setModal] = useState(false);
  ...
  return (
    ...
    <TouchableOpacity onPress={() => navigation.goBack()} >
      ...
      <Text style={{ color: "black", fontSize: 25, fontWeight: "bold" }}> KARNA</Text>
        ...
        <View style={{flex:1, marginTop:5 }}>
         ...
         <View style={{alignItems:"center",justifyContent:"center"}}>
          ...
          <View style={styles.usercon}>
           ...
           <Text style={{fontSize:19,fontWeight:"800"}}>hari</Text>
           <Text style={{fontSize:15,fontWeight:"300"}}>chennai</Text>
           </View>
  ...
  {/* About */}
    <View style={{flex:1}}>
      <Text style={{fontSize:19,fontWeight:"900", borderBottomColor:"black",marginBottom:10,marginLeft:10}}>About</Text>
       ...
       {item.phoneNumber},{item.desc}</Text>
    </View>
    {/* orderthe product */}
             ...
             >
              <View style={{width:350,height:200,backgroundColor:"white",alignItems:"center",marginTop:300,flex:1,margin:10,borderTopLeftRadius:20,borderTopRightRadius:20,borderColor:"black"}}>
                  <View style={{alignItems:"center",justifyContent:"center"}}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate("agri")}>
...
export default AgriDetailspage