...
import { StyleSheet, Text, View, Modal, Button, TextInput, ScrollView, Alert, TouchableOpacity,Platform } from 'react-native';
...
function DonarVegcreate({navigation}) {
      ...
      <FontAwesome name="user" size={20} color="black" />
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <View style={styles.container}>
                        <Text style={{ alignSelf: "center", fontSize: 30 }}>VEG</Text>
