...
function NonVegpage({navigation}) {
  ...
  const rendernonveg = ({ item }) => {
    ...
    return (
      ...
      <TouchableOpacity onPress={() => navigation.goBack()}>
        ...
        <Text style={{ color: "black", fontSize: 20, fontWeight: "bold",marginLeft:20 }}>Non-Vegetarian</Text>
   ...
   <View style={styles.catg}>
      <Text style={{ fontSize: 15, fontWeight: "300", color: 'black', textAlign: "center",alignSelf:"center", padding:8 }} >Chicken</Text>
    </View>
    </TouchableOpacity>
    <TouchableOpacity>
    <View style={styles.catg}>
      <Text style={{ fontSize: 15, fontWeight: "300", color: 'black', textAlign: "center",alignSelf:"center", padding:8 }}>sausages</Text>
    </View>
    </TouchableOpacity>
    <TouchableOpacity>
     <View style={styles.catg}>
      <Text style={{ fontSize: 15, fontWeight: "300", color: 'black', textAlign: "center",alignSelf:"center", padding:8 }}>lambchops</Text>
    </View> 
    </TouchableOpacity>
   </View>
   {/* first line */}
   ...
   <TouchableOpacity>
   <View style={styles.catg}>
      <Text style={{ fontSize: 15, fontWeight: "300", color: 'black', textAlign: "center",alignSelf:"center", padding:8 }} >hotdog bun</Text>
    </View>
    </TouchableOpacity>
    <TouchableOpacity>
    <View style={styles.catg}>
      <Text style={{ fontSize: 15, fontWeight: "300", color: 'black', textAlign: "center",alignSelf:"center", padding:8 }}>porkbelly</Text>
    </View>
    </TouchableOpacity>
