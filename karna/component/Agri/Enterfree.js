  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{  alignItems: "center", justifyContent: "center",marginTop:100 }}>
        ...
        <Text style={{ fontSize: 30, fontWeight: "bold", color: "black", marginTop: 10 }}>Free Selling on Karna</Text>
      </View>
...
<View style={{flex:1,alignItems:"center",alignContent:"center",marginTop:100}}>
        <Pressable onPress={() => navigation.navigate("free")}>
